...
Design system framework. Use when the project needs this capability or the user / team manifest asks for it.

## When to use

- `TEAM.yaml` includes `canvas-design` or user asks by name
...
2. **Confirm tooling** - Verify `canvas-design` runtime/CLI/MCP is available; document install if missing.
