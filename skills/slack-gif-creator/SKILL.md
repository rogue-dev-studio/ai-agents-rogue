...
Slack GIF generation. Use when the project needs this capability or the user / team manifest asks for it.

## When to use

- `TEAM.yaml` includes `slack-gif-creator` or user asks by name
...
2. **Confirm tooling** - Verify `slack-gif-creator` runtime/CLI/MCP is available; document install if missing.
