...
AI-powered ontology enrichment. Use when the project needs this capability or the user / team manifest asks for it.

## When to use

- `TEAM.yaml` includes `ontology-enrich` or user asks by name
...
2. **Confirm tooling** - Verify `ontology-enrich` runtime/CLI/MCP is available; document install if missing.
