...
Document to ontology import. Use when the project needs this capability or the user / team manifest asks for it.

## When to use

- `TEAM.yaml` includes `import-to-ontology` or user asks by name
...
2. **Confirm tooling** - Verify `import-to-ontology` runtime/CLI/MCP is available; document install if missing.
