...
- `TEAM.yaml` includes `nodejs-devtools` or user asks by name
...
2. **Confirm tooling** - Verify `nodejs-devtools` runtime/CLI/MCP is available; document install if missing.
