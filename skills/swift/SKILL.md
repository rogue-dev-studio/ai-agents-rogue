...
**Level: max** specialized skill (not merged). Category hint: `languages`.

## Summary

Swift programming language. Use when the project needs this capability or the user / team manifest asks for it.

## When to use

- `TEAM.yaml` includes `swift` or user asks by name
...
2. **Confirm tooling** - Verify `swift` runtime/CLI/MCP is available; document install if missing.
