...
- `TEAM.yaml` includes `algorithmic-art` or user asks by name
...
2. **Confirm tooling** - Verify `algorithmic-art` runtime/CLI/MCP is available; document install if missing.
